# Generated by Django 2.0.5 on 2019-12-28 14:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('idcs', '0001_initial'),
        ('manufacturer', '0002_auto_20191228_1418'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip6_addr', models.CharField(db_index=True, help_text='ipv6地址', max_length=45, unique=True, verbose_name='ipv6地址')),
                ('netmask', models.CharField(help_text='子网掩码', max_length=15, verbose_name='子网掩码')),
                ('gateway', models.CharField(db_index=True, help_text='网关地址', max_length=15, unique=True, verbose_name='网关地址')),
                ('ip6_gateway', models.CharField(db_index=True, help_text='IPV6网关地址', max_length=45, unique=True, verbose_name='IPV6网关地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(help_text='系统', max_length=50, verbose_name='系统')),
                ...
                ('cabinet_position', models.CharField(help_text='机柜所在位置', max_length=20, null=True, verbose_name='机柜所在位置')),
